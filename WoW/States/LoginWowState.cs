    ...
    class LoginWowState : State
    {
        ...
        public override void Run()
        {
            ...
            if (IsErrorDialogVisible)
            {
                ...
                _wowManager.Profile.ShoudPause = true;
                return;
            }
        ...
        private const string BANNED_TITLE_TEXT = "Ошибка Battle.net №202";
        ...
        private const string SUSPENED_TEXT = "Ошибка Battle.net №203";
        ...
        private const string FROZEN_TEXT = "Ошибка Battle.net №206";
        ...
        private const string IS_LOCKED_LICENSE_TEXT = "Ошибка Battle.net №204";
        ...
        private const string LOCKED_TEXT1 = "Ошибка Battle.net №42003";
        private const string LOCKED_TEXT2 = "Ошибка Battle.net №141";
